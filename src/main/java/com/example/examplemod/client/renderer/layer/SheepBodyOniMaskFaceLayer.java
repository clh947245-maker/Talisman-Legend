...
public class SheepBodyOniMaskFaceLayer extends RenderLayer<SheepBodyEntity, PlayerModel<SheepBodyEntity>> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(ChenMod.MODID, "textures/entity/oni_mask_face.png");

    public SheepBodyOniMaskFaceLayer(RenderLayerParent<SheepBodyEntity, PlayerModel<SheepBodyEntity>> renderer) {
        super(renderer);
    }
    ...
    public void render(
        ...
        ItemStack headStack = body.getItemBySlot(EquipmentSlot.HEAD);
        if (!OniMaskItem.isOniMask(headStack) || body.isInvisible() || body.isSnackInvisible()) {
            return;
        }
        ...
        int overlay = LivingEntityRenderer.getOverlayCoords(body, 0.0F);
